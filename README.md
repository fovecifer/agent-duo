...
| `peer loop init <id> --mission ... --max-rounds N [--validation id:cmd]` / `peer loop <id>` | Freeze and inspect a worker loop contract with a mechanical round budget; optional validations gate `done` against `success_signals` |
